...
export class BillingService {
  ...
  createInvoice(data: {
    ...
    return this.http.post<BillingResponse>(`${this.apiUrl}/invoices`, data, {
  ...
  getInvoiceById(id: string): Observable<BillingResponse> {
    return this.http.get<BillingResponse>(`${this.apiUrl}/invoices/${id}`, {
      headers: this.getHeaders(),
    });
  }
  ...
  getPricingRules(): Observable<BillingResponse> {
    return this.http.get<BillingResponse>(`${this.apiUrl}/rules`, {
      headers: this.getHeaders(),
    });
  }

  getStats(): Observable<BillingResponse> {
    return this.http.get<BillingResponse>(`${this.apiUrl}/stats`, {
      headers: this.getHeaders(),
    });
  }
}
